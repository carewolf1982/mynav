...
(3,'PT邀请码','https://www.ptyqm.com/','fa-key','#666','PT',1),
(3,'HDSky','https://hdsky.me/login.php','fa-download','#666','PT',2),
(3,'私人导航','https://mynav-68k.pages.dev/','fa-home','#666','导航',3),
(4,'电子采购','https://sso.cnncecp.com/login/','fa-shopping-cart','#666','工作',1),
(4,'核安全注册','https://www.chinansc.cn/haqgcs/','fa-shield','#666','工作',2),
(4,'EB技术','https://support.aucotec.cn/web/home/index','fa-wrench','#666','工作',3),
(4,'团标公开','http://39.104.123.74:8088/standardview/public/index.php/admin/index/index','fa-file-text','#666','工作',4),
(4,'标准管理','http://39.104.123.74:8088/standard/public/index.php/admin/login.html','fa-file-check','#666','工作',5),
(4,'核协E+','https://www.caini.cn/zhhx/1223999/szhzx/1431503/index.html','fa-mobile','#666','工作',6),
(5,'MockingBird','https://gitee.com/babysor/MockingBird','fa-microphone','#666','AI',1),
(5,'顶牛闯关','https://dingniu.suyangx.com/learnspace/learn/learn/xsc/au_steamList.action','fa-graduation-cap','#666','学习',2),
(5,'句乐部','https://julebu.co/','fa-book-open','#666','学习',3),
(5,'玻尔','https://www.bohrium.com/','fa-atom','#666','AI',4),
(5,'Datawhale','https://www.datawhale.cn/home','fa-wave-square','#666','AI',5),
(5,'uinodes','https://uinodes.com/','fa-code','#666','学习',6),
(5,'IAEA CSS','https://nucleus.iaea.org/sites/committees','fa-globe','#666','标准',7),
(5,'SoybeanAdmin','https://docs.soybeanjs.cn/zh/','fa-layout','#666','框架',8),
(5,'Pure Admin','https://pure-admin.cn/pages/start/','fa-window-maximize','#666','框架',9),
(5,'RD Web','https://cloud.aucotec.cn:888/RDWeb/Pages/zh-CN/login.aspx','fa-desktop','#666','远程',10),
(5,'PMP考试','https://yun.aura.cn/Packet/detail/lid/764.html','fa-certificate','#666','认证',11),
(5,'百度网盘','https://pan.baidu.com/s/1I7wJEasY79IekNO7UMlb-A','fa-cloud-download','#666','云盘',12),
(5,'入学服务','https://qryjrx.bjedu.cn/hdxsc','fa-graduation-cap','#666','教育',13),
(5,'统一认证','https://am.bjedu.cn/am/UI/Login','fa-key','#666','认证',14);
