...
export async function onRequestPost(context) {
  ...
  return new Response(JSON.stringify({ code: 0, msg: "新增成功" }), { headers: { "Content-Type": "application/json" } });
}
...
export async function onRequestPut(context) {
  ...
  return new Response(JSON.stringify({ code: 0, msg: "修改成功" }), { headers: { "Content-Type": "application/json" } });
}
