...
export async function onRequestPost(context) {
  ...
  return new Response(JSON.stringify({ code: 0, msg: "分类新增成功" }), { headers: { "Content-Type": "application/json" } });
}
...
export async function onRequestPut(context) {
  ...
  return new Response(JSON.stringify({ code: 0, msg: "分类修改成功" }), { headers: { "Content-Type": "application/json" } });
}
...
export async function onRequestDelete(context) {
  ...
  return new Response(JSON.stringify({ code: 0, msg: "分类删除成功" }), { headers: { "Content-Type": "application/json" } });
}